...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/snowball
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/snowball-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using snowball:subagent-driven-development. The plan is at: $PLAN_PATH"
