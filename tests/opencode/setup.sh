...
#   $OPENCODE_CONFIG_DIR/snowball/             ← package root
#   $OPENCODE_CONFIG_DIR/snowball/skills/      ← skills dir (../../skills from plugin)
#   $OPENCODE_CONFIG_DIR/snowball/.opencode/plugins/snowball.js ← plugin file
#   $OPENCODE_CONFIG_DIR/plugins/snowball.js   ← symlink OpenCode reads

SNOWBALL_DIR="$OPENCODE_CONFIG_DIR/snowball"
SNOWBALL_SKILLS_DIR="$SNOWBALL_DIR/skills"
SNOWBALL_PLUGIN_FILE="$SNOWBALL_DIR/.opencode/plugins/snowball.js"
...
ln -sf "$SNOWBALL_PLUGIN_FILE" "$OPENCODE_CONFIG_DIR/plugins/snowball.js"
...
echo "Snowball dir:      $SNOWBALL_DIR"
echo "Skills dir:           $SNOWBALL_SKILLS_DIR"
echo "Plugin file:          $SNOWBALL_PLUGIN_FILE"
echo "Plugin registered at: $OPENCODE_CONFIG_DIR/plugins/snowball.js"
...
export REPO_ROOT
export SNOWBALL_DIR
export SNOWBALL_SKILLS_DIR
export SNOWBALL_PLUGIN_FILE
