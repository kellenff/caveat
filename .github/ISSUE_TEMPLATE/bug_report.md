...
## Is this a Snowball issue or a platform issue?
<!-- Snowball is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Snowball installed.

     If the problem persists without Snowball, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Snowball installed
